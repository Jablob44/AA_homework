...
def titleize(title)
  words = title.split(" ")
  little_words = [ "and", "the", "over", "a", "on", "of" ] # the array was outside of the scope of the method
  titleized_words = words.map.with_index do |word, i| #index and word were flipped
...
p titleize("the insane adventures of yo mama and a cow")